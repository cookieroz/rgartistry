 ...
 *
 * @uses rachel_makeup_header_style()
 * @uses rachel_makeup_admin_header_style()
 * @uses rachel_makeup_admin_header_image()
 */
function rachel_makeup_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'rachel_makeup_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000000',
		'width'                  => 1000,
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'rachel_makeup_header_style',
		'admin-head-callback'    => 'rachel_makeup_admin_header_style',
		'admin-preview-callback' => 'rachel_makeup_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'rachel_makeup_custom_header_setup' );

if ( ! function_exists( 'rachel_makeup_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see rachel_makeup_custom_header_setup().
 */
function rachel_makeup_header_style() {
...
endif; // rachel_makeup_header_style

if ( ! function_exists( 'rachel_makeup_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see rachel_makeup_custom_header_setup().
 */
function rachel_makeup_admin_header_style() {
?>
	<style type="text/css">
...
endif; // rachel_makeup_admin_header_style

if ( ! function_exists( 'rachel_makeup_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see rachel_makeup_custom_header_setup().
 */
function rachel_makeup_admin_header_image() {
?>
	<div id="headimg">
...
endif; // rachel_makeup_admin_header_image
